...
headers_list = [['a','b','c'],['d','e','f']]
headers_new = [{'headers': [('Name', 'aaa'), ('Port', '80'), ('Description', 'bbb'), ('Protocol', 'TCP'), ('Severity', 'ccc'), ('Code', '123'), ('Host', 'asdf.es'), ('IP', '-'), ('State', 'OPEN'), ('Solution', 'aaax'), ('CVSS', 'bbbx'), ('CVSS_image', 'cccx'), ('URLs', ['/rrr.com ', '/uudu ', '/faviconxxx.ico '])]},  
 {'headers': [('Name', 'xxx'), ('Port', '80'), ('Description', 'yyy'), ('Protocol', 'TCP'), ('Severity', 'zzz'), ('Code', ''), ('Host', 'redesdecomputadores.umh.es'), ('IP', '-'), ('State', 'OPEN'), ('Solution', 'aaa'), ('CVSS', 'bbb'), ('CVSS_image', 'ccc'), ('URLs', ['/robots.txt ', '/aplicacion ', '/favicon.ico '])]}]
